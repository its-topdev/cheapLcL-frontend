...
export default function ShipperAddModal({onCloseButtonClick, onGetShippers, onSetShipper}) {
  ...
  useEffect(() => {
    if (createShipperData != null) {
      ...
      onSetShipper({value: createShipperData.id, label: createShipperData.name});
      onGetShippers();
    ...
    return PortalReactDOM.createPortal(
        <div className="shipper-modal modal-wrapper">
            <div className="modal">
                ...
                <h3 className="shipper-modal-second-title">Please Fill in Your Details Below:</h3>
                <ShipperForm onSubmitForm={addShipper} eventOnCloseButtonClick={onCloseButtonClick} />
            </div>
        </div>
        , document.body
    );
