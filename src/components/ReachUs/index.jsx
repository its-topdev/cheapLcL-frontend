...
function ReachUs() {
  ...
  const {
    data: reachUsData,
    loading: reachUsIsLoading,
    fetchData: fetchReachUs,
  } = useFetch();
  ...
  return (
    <div className="reachus">
      ...
      <div className="reachus-text">
        Use the form below to send us any question
      </div>
      <form className="reachus-form">
        ...
        <div className="reachus-form-textarea">
          ...
          <textarea
            ...
            className="reachus-form-textarea-element"
            name="reachus"
            rows={4}
            placeholder="How can we help you?"
          />
        </div>
        <div className="reachus-form-button">
          <button
            ...
            type="submit"
          >
            {reachUsIsLoading ? <Loader /> : "Submit"}
          </button>
        </div>
      </form>
    </div>
