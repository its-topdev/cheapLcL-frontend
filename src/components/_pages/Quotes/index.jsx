...
export default function Quotes() {
    ...
    const {data: quotesData, loading: quotesLoading, error, fetchData} = useFetch();

    const fetchQuotes = () => {
        try {
            fetchData(`${API_URL}book/list?page=${currentPage}&pageSize=${pageSize}`, 'get');        
        } catch (error) {
            console.log(error);
        }
    };
        ...
        <>
            ...
            <div className="management-body-table">
                <table>
                    ...
                    <tbody>{quotesLoading ? <tr><td><Loader /></td></tr> : rows }</tbody>
                </table>
            </div>
