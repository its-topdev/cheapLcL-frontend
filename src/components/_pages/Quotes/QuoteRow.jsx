...
import { BookRequestPrefix, dateTimeFormat, priceFormat } from '../../../constants/general';
...
export default function QuoteRow({ quote, onfetchQuotes }) {
    ...
    return (
        <tr className="quote-row">
            <td>{BookRequestPrefix}-{quote.id}</td>
            ...
            <td>{quote.bookStatus && quote.bookStatus.name && quote.bookStatus.name.toUpperCase()}</td>
            <td>
