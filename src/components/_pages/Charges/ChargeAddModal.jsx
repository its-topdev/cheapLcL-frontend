...
export default function ChargeAddModal({
  show,
  onFetchCharges,
  onCloseButtonClick,
}) {
  ...
  const addCharge = async (data) => {
    ...
    await fetchAddCharge(`${API_URL}charge/create`, "post", payload, true);
  };
  ...
  return PortalReactDOM.createPortal(
    ...
    >
      <div className="modal">
        ...
        <ChargeForm
          onSubmitForm={addCharge}
          eventOnCloseButtonClick={onCloseButtonClick}
          loadingCharge={chargeLoading}
        />
      </div>
    </div>,
    document.body
